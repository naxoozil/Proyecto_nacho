...
public class GestorDeTabs extends AppCompatActivity implements FragmentoGeneral.OnFragmentInteractionListener, FragmentoGaleria.OnFragmentInteractionListener,FragmentOtros.OnFragmentInteractionListener{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_gestor_de_tabs, menu);
        return true;
    }
